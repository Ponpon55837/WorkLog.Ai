    ...
    <template v-else-if="report">
      ...
      <div class="report-tab-panels">
        <section id="report-tab-panel-overview" class="report-tab-panel" role="tabpanel" aria-labelledby="report-tab-overview" v-show="reportTab === 'overview'">
          <details class="report-synthesis-card" data-testid="report-synthesis" :open="reportSynthesisExpanded || !reportSynthesisSummary" @toggle="reportSynthesisExpandedModel = ($event.currentTarget as HTMLDetailsElement).open">
